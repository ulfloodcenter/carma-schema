...
### Duplicate counties
```
$ carma-validator -s carma_schema/data/schema/CARMA-schema-20210505.json -d tests/fixtures/sample_carma_data_1_dupCounty.json
...
```
$ carma-validator -s carma_schema/data/schema/CARMA-schema-20210505.json -d tests/fixtures/sample_carma_data_1_invalidWaterSource.json
...
Path: /Counties/1/maxStreamOrder, error: -3 is less than the minimum of 1
Path: /PowerPlantDatasets/0/eiaLongitude, error: -188.01089992 is less than the minimum of -180
```
