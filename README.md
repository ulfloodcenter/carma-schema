...
```
$ carma-validator -s carma_schema/data/schema/CARMA-schema-20210805.json -d tests/fixtures/sample_carma_data_2_missingGeom.json
...
```
$ carma-validator -s carma_schema/data/schema/CARMA-schema-20210805.json -d tests/fixtures/sample_carma_data_1_unknown-huc12.json
...
### Duplicate counties
```
$ carma-validator -s carma_schema/data/schema/CARMA-schema-20210805.json -d tests/fixtures/sample_carma_data_1_dupCounty.json
...
### Duplicate HUC-12s:
```
$ carma-validator -s carma_schema/data/schema/CARMA-schema-20210805.json -d tests/fixtures/sample_carma_data_1_dupHUC12.json
...
```
$ carma-validator -s carma_schema/data/schema/CARMA-schema-20210805.json -d tests/fixtures/sample_carma_data_1_invalidWaterSource.json
...
### Unknown Sector:
```
$ carma-validator -s carma_schema/data/schema/CARMA-schema-20210805.json -d tests/fixtures/sample_carma_data_1_invalidSector.json
...
### Missing Unit:
```
$ carma-validator -s carma_schema/data/schema/CARMA-schema-20210805.json -d tests/fixtures/sample_carma_data_1_missingUnit.json
...
### Invalid Unit:
```
$ carma-validator -s carma_schema/data/schema/CARMA-schema-20210805.json -d tests/fixtures/sample_carma_data_1_invalidUnit.json
...
### Invalid Years:
```
$ carma-validator -s carma_schema/data/schema/CARMA-schema-20210805.json -d tests/fixtures/sample_carma_data_1_invalidYear.json
...
### Invalid Numbers:
```
$ carma-validator -s carma_schema/data/schema/CARMA-schema-20210805.json -d tests/fixtures/sample_carma_data_1_invalidNumbers.json
...
### Valid:
```
$ carma-validator -s carma_schema/data/schema/CARMA-schema-20210805.json -d tests/fixtures/sample_carma_data_1.json
