...
def join_wassi_values_to_huc12(wassi_analysis: AnalysisWaSSI, huc12_properties: dict) -> dict:
    huc12_id = huc12_properties['id']
    wassi_match = False
    for wassi_value in wassi_analysis.wassiValues:
        if wassi_value.huc12 == huc12_id:
            ...
            wassi_match = True
    if wassi_match:
        huc12_properties['wassi_year'] = wassi_analysis.waterUseYear
        huc12_properties['wassi_id'] = str(wassi_analysis.id)
    return huc12_properties
